...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        if (!$user['email_verified']) {
            ...
            if ($user['role'] !== 'admin') {
                $error = "This login page is for admin only. Please use the <a href='/finalproject/booknestonlinebookstoresystem/Customer/login.php'>Customer Login</a> or <a href='/finalproject/booknestonlinebookstoresystem/Staff/staffLogin.php'>Staff Login</a>.";
            } else {
...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card shadow">
            <div style="background: #ea1010; color: white; border-radius: 28px 28px 0 0; padding: 1.5rem; text-align: center;">
