            ...
            <tr class="<?= $isLowStock ? 'low-stock' : '' ?>">
                ...
                <td>
                    <form method="POST" class="quick-stock-form">
                        ...
                        <input type="number" name="stock_delta" value="0" class="form-control form-control-sm" required>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4"><label class="form-label">Min Stock Threshold</label><input type="number" name="min_stock" id="min_stock" class="form-control" value="5"></div>
                        <div class="col-md-4" id="stockFieldRow">
                            <label class="form-label">Initial Stock</label>
                            <input type="number" name="stock" id="stock" class="form-control" value="0" min="0">
                        </div>
                        <div class="col-12"><label class="form-label">Cover Image</label><input type="file" name="image" class="form-control" accept="image/jpeg,image/png,image/gif" id="imageInput">
